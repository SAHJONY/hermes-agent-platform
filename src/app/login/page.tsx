    ...
    <div className="min-h-screen flex">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 glass rounded-xl hover:bg-white/10 transition-colors disabled:opacity-50"
            >
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-purple-900/50 to-cyan-900/50 items-center justify-center">
        <div className="max-w-lg text-center p-8">
          ...
          <h2 className="text-3xl font-bold mb-4">Welcome to Hermes</h2>
